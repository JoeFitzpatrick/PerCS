...
$(function(){
	...
	/*b var $presentedText = $("#presentedText");
	var $presentedSpeech = $("#presentedSpeech");
	var $presentedVisual = $("#presentedVisual"); */
	var $modalatiesYes = $("#modalatiesYes");
	var $modalatiesNo = $("#modalatiesNo");
	...
	var modalatiesYesTrigger = 0;
	var modalatiesYesChosen = 0;
	var modalatiesNoTrigger = 0;
	var modalatiesNoChosen = 0;
	...
	$modalatiesYes.on("click", function() {
		if (modalatiesYesTrigger == 0){
			$("#modalatiesYes").css("outline", "3px solid #3393FF");
			modalatiesYesTrigger = 1;
			modalatiesYesChosen = 1;
			$("#modalatiesNo").css("outline", "none");
			modalatiesNoTrigger = 0;
			modalatiesNoChosen = 0;
		} else {
			$("#modalatiesYes").css("outline", "none");
			modalatiesYesTrigger = 0;
			modalatiesYesChosen = 0;
		}
		
	});

	$modalatiesNo.on("click", function() {
		if (modalatiesNoTrigger == 0){
			$("#modalatiesNo").css("outline", "3px solid #3393FF");
			modalatiesNoTrigger = 1;
			modalatiesNoChosen = 1;
			$("#modalatiesYes").css("outline", "none");
			modalatiesYesTrigger = 0;
			modalatiesYesChosen = 0;
		} else {
